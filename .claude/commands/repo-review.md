...
1. Run each selected dimension as its own gated `Workflow`, dimension 6
    before dimension 5 so 6's confirmed findings can seed 5 — wait for
    "go", fan out finder slices, refute every finding (up to the per-dimension
