...
- **Ratchet pin audit** — daily detection of tag-vs-SHA drift on pinned action refs; deduped `ratchet-drift` umbrella issue auto-opens/closes. → [runbooks/ratchet-pin-audit.md](runbooks/ratchet-pin-audit.md) <!-- enforcer: scripts/check-ratchet-pin-audit.sh; ci: -; hook: - -->
