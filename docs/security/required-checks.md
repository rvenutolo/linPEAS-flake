...
| nix-run-pinned                  | ci                | .github/workflows/ci.yml                |
...
| gh-api-version-header           | ci                | .github/workflows/ci.yml                |
| refresh-ci-dag-test             | ci                | .github/workflows/ci.yml                |
| refresh-ci-summary-test         | ci                | .github/workflows/ci.yml                |
| refresh-enforcement-matrix-test | ci                | .github/workflows/ci.yml                |
| refresh-just-recipes-test       | ci                | .github/workflows/ci.yml                |
| refresh-precommit-table-test    | ci                | .github/workflows/ci.yml                |
| refresh-scripts-reference-test  | ci                | .github/workflows/ci.yml                |
| refresh-treefmt-config-test     | ci                | .github/workflows/ci.yml                |
