...
| `ratchet-pin-audit`               | `15 9 * * *`    | 09:15 daily  | Re-derive the canonical SHA of every patch-tagged action pin (local, self-reference and floating-major pins excluded); fire on an upstream tag force-move |
