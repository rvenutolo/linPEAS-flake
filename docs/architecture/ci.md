...
| `lint-script-hygiene`        | Batched shell-hygiene member lints over `scripts/` and `tests/`; e.g. shebang/pipefail, harness preambles, per-script test coverage, helper routing, and path hygiene                                                                                                                                                                                                                                             |
