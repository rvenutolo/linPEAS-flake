...
| `lint-doc-invariants`        | Batched doc-invariant member lints, covering invariant-index integrity, doc anchors, ephemeral references, cron restatement, and schema validation                                                                                                                                                                                       |
| `lint-script-hygiene`        | Batched shell-hygiene member lints over `scripts/` and `tests/`, covering shebang/pipefail, harness preambles, per-script test coverage, helper routing, and path hygiene                                                                                                                                                                |
