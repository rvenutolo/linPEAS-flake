...
| `lint-script-hygiene`        | Batched shell-hygiene member lints (18) over `scripts/` and `tests/`, covering shebang/pipefail, harness preambles, per-script test coverage, helper routing, and path hygiene                                                                                                                                                                |
