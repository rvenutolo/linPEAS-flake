...
- Runtime check: [ratchet-pin-audit](../runbooks/ratchet-pin-audit.md)
    ...
    tag dereferences to — so a tag-object pin whose comment names a
    versioned tag (the marker-free case under Exceptions above) is not
    mistaken for drift, while a
